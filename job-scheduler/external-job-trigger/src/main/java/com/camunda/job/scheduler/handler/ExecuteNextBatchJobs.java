...
@Slf4j
@Component
@ExternalTaskSubscription("executeNextJob")
public class ExecuteNextBatchJobs implements ExternalTaskHandler{

    private final BatchJobExecutor batchJobExecutor;

    public ExecuteNextBatchJobs(BatchJobExecutor batchJobExecutor) {
